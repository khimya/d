                            ...
                            <div class="tshadow mb25 bozero">  
                                ...
                                <div class="around10">  
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo "CIN" ?></label>
                                                <input id="father_cin" name="father_cin" placeholder="" type="text" class="form-control"  value="<?php echo set_value('father_cin'); ?>" />
                                            </div>
                                        </div>
                                         <div class="col-md-3">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                         ...
                                         <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo "CIN" ?></label>
                                                <input id="mother_cin" name="mother_cin" placeholder="" type="text" class="form-control"  value="<?php echo set_value('mother_cin'); ?>" />
                                            </div>
                                        </div>
                                         <div class="col-md-3">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo "CIN" ?></label>
                                                <input id="guardian_cin" name="guardian_cin" placeholder="" type="text" class="form-control"  value="<?php echo set_value('guardian_cin'); ?>" />
                                            </div>
                                        </div>
                                         <div class="col-md-3">
                                            <div class="form-group">
